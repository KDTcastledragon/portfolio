...
## 2026-07-14 CastleChat Page

- [x] Replace the CastleChat-only header with a fixed portfolio header.
- [x] Move CastleChat content into the requested project-stage box layout.
- [x] Restore the original background, colors, typography, and text sizes.
- [x] Keep the header and project box dark while making every outside area white.
- [x] Remove all unrequested overview labels, descriptions, and metadata.
- [x] Fit the desktop CastleChat page within the viewport without a vertical scrollbar.
- [x] Preserve the existing headline typography and deployment actions.
- [x] Add the requested right-side project navigation.
- [x] Remove the old principle panel and its copy.
- [x] Keep architecture and stack dialogs working.
- [x] Verify HTML, JavaScript, responsive CSS, and Git diff.

## 2026-07-13 Architecture

- [x] Add architecture navigation button.
- [x] Add one-screen architecture board.
- [x] Draw REST, WSS, gRPC, Kafka, SQL, Redis, and Gemini flows.
- [x] Add desktop and mobile layouts.
- [x] Add keyboard-accessible view switching.
- [x] Validate HTML and inspect Git diff.

## 2026-07-14 CastleChat visual polish

- [x] Lighten the CastleChat project palette to a comfortable green tone.
